...
- [ ] Crates.io readiness for `why-core` documented and validated before claiming `cargo install why-core` support
...
jobs:
  risk-review:
    ...
    steps:
      ...
      - name: Install why (once crates.io publication is enabled)
